...
@section('content')
    <div class="max-w-xl mx-auto bg-white p-6 shadow rounded">
        ...
        <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="title" class="w-full border px-3 py-2 mb-4" required>
            <div class="mb-4">
            ...
            <textarea name="content" rows="5" class="w-full border px-3 py-2 mb-4" required></textarea>
